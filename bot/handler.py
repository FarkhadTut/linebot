...
def handler(body, x_line_signature):
    ...
    user_id = body['events']['message']['source']['userId']
    reply_token = body['events']['replyToken']
    ...
    #logic
    type_ = body['events']['message']['type']
    ...
    if users[user_id] == 1:
        ...
        if type_ != 'location':
            ...
            address = body['events']['message']['address']
